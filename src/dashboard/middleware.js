...
function dynamicCSP() {
    return (req, res, next) => {
        ...
        const cspDirectives = {
            ...
            'script-src-elem': ["'self'", "'unsafe-inline'", "https://js.stripe.com", "https://cdn.jsdelivr.net", "https://static.cloudflareinsights.com"],
            'script-src-attr': ["'unsafe-inline'"],
            'frame-src': ["https://js.stripe.com", "https://hooks.stripe.com"],
            'connect-src': ["'self'", "https://api.stripe.com", "https://cdn.jsdelivr.net", "https://cloudflareinsights.com", wsUrl],
...
/**
 * UTF-8 charset for all responses — ensures emoji/multibyte chars are preserved
 */
function utf8Charset() {
    return (req, res, next) => {
        // Force UTF-8 on all HTML and JSON responses
