    ...
    try {
        ...
        res.json({
            ...
            user: {
                ...
                notifications: user.notifications ? (typeof user.notifications === 'string' ? JSON.parse(user.notifications) : user.notifications) : { securityAlerts: true, productUpdates: true, emailNotifications: true },
    ...
    try {
        ...
        const apps = [
            ...
            },
            {
                id: 'darklock-guard',
                name: 'Darklock Guard',
                description: 'Desktop security application for real-time file integrity monitoring, zero-trust device authentication, and system protection.',
                icon: 'monitor-shield',
                status: 'active',
                url: null,
            ...
            },
            {
                id: 'secure-channel',
                name: 'Secure Channel',
                description: 'End-to-end encrypted messaging platform with voice, video, and secure file sharing for teams and communities.',
                icon: 'message-lock',
                status: 'beta',
                url: 'https://channel.darklock.net',
                category: 'Communication',
                features: ['E2E Encryption', 'Voice & Video', 'File Sharing', 'Servers', 'DMs']
            },
            {
                id: 'darklock-vpn',
                name: 'Darklock VPN',
                description: 'High-speed encrypted VPN service with zero-log policy, built-in ad blocking, and multi-hop routing for maximum privacy.',
                icon: 'globe-lock',
                status: 'coming-soon',
                url: null,
                category: 'Privacy',
            ...
            },
            {
                id: 'threat-monitor',
                name: 'Threat Monitor',
                description: 'Real-time threat detection and alerting system for your digital infrastructure with AI-powered analysis.',
                icon: 'radar',
                status: 'coming-soon',
                url: null,
                category: 'Security',
                features: ['Real-time Alerts', 'Threat Intelligence', 'Incident Response', 'AI Analysis']
            },
            {
                id: 'secure-vault',
                name: 'Secure Vault',
                description: 'Encrypted credential management and secure secret storage for individuals and teams with biometric unlock.',
                icon: 'lock-keyhole',
                status: 'coming-soon',
                url: null,
                category: 'Security',
                features: ['End-to-end Encryption', 'Team Sharing', 'Biometric Unlock', 'Auto-Fill']
            },
            {
                id: 'darklock-dns',
                name: 'Darklock DNS',
                description: 'Privacy-first DNS resolver with built-in malware blocking, parental controls, and analytics dashboard.',
                icon: 'dns-shield',
                status: 'coming-soon',
                url: null,
                category: 'Privacy',
                features: ['Malware Blocking', 'Parental Controls', 'Analytics', 'DoH/DoT']
            },
            {
                id: 'darklock-cloud',
                name: 'Darklock Cloud',
                description: 'Zero-knowledge encrypted cloud storage with automatic backup, file versioning, and cross-device sync.',
                icon: 'cloud-lock',
                status: 'coming-soon',
                url: null,
                category: 'Storage',
                features: ['Zero-Knowledge Encryption', 'Auto Backup', 'File Versioning', 'Cross-Device Sync']
            }
        ];
